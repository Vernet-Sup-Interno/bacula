# Bacula 11.0.6 Container

Deploy the bacula community edition on Docker Containers. 

## Images

- [x] Bacula Catalog                    fametec/bacula-catalog:11.0.6
- [x] Bacula Director                   fametec/bacula-director:11.0.6
- [x] Bacula Storage Daemon             fametec/bacula-storage:11.0.6
- [x] Bacula File Daemon                fametec/bacula-client:11.0.6
- [x] Baculum Web Gui                   fametec/baculum-web:11.0.6 (NEW)
- [x] Baculum API                       fametec/baculum-api:11.0.6 (NEW)
...
docker-compose.yaml
    ...
    services:
      db:
        image: fametec/bacula-catalog:11.0.6
        ...
        ports:
          - 5432
      bacula-dir:
        image: fametec/bacula-director:11.0.6
        restart: unless-stopped
        volumes:
        ...
        ports:
          - 9101
      bacula-sd:
        image: fametec/bacula-storage:11.0.6
        restart: unless-stopped
        depends_on:
          - bacula-dir
          - db
        ...
        ports:
          - 9103
      bacula-fd:
        image: fametec/bacula-client:11.0.6
        restart: unless-stopped
        depends_on:
          - bacula-sd
          - bacula-dir
